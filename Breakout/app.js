...
const blockWidth = 100, blockHeight = 20;
...
// changing the movement of the user
function drawUser() {
...
// changing the movement of the ball
function drawBall() {
...
function collisionCheck() {
    ...
    // gets struck on the right side
    if (ballCurrentPosition[0] >= (boardWidth - ballDiameter)) {
        changeDirection();
    }

    // gets struck on the top side
    if (ballCurrentPosition[1] >= (boardHeight - ballDiameter)) {
        changeDirection();
    }

    // gets struck on the left side
